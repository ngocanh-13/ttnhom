...
namespace Cuahangbangas
{
    public partial class Hoadonban : Form
    {
        ...
        {
            string sql;
            sql = "SELECT a.mahang, b.tenhang, a.soluong, b.dongiaban, a.khuyenmai, a.thanhtien FROM tblchitiethdban AS a, tblhang AS b WHERE a.mahdban = N'" + txtMaHDBan.Text + "' AND a.mahang=b.mahang";
