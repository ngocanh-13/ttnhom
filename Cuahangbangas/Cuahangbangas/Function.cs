...
namespace Cửa_hàng_Gia_Thịnh
{
    class Functions
    {
        ...
        public static string ThayDoiNgay(string macu, string date)
        {

            string mamoi = "";
            string[] partsDay = date.Split('/');
            string d = String.Format("{0}{1}{2}", partsDay[0], partsDay[1], partsDay[2]);
            mamoi = macu.Substring(0, 3) + d + macu.Substring(11);
            return mamoi;
        }
        ...
        internal static void FillCombo(string p, ComboBox cboManhanvien, string p_2)
        {
